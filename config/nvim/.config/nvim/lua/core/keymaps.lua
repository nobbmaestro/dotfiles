...
vim.keymap.set("n", "<leader>gl", "<cmd>LazyGitLog<CR>", { desc = "lazyGit: Open log" })
vim.keymap.set("n", "<leader>gbl", "<cmd>LazyGitFileFilter<CR>", { desc = "lazyGit: Open log for current buffer" })
